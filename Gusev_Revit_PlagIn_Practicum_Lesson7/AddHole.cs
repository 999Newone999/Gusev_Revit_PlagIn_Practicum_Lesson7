...
namespace Gusev_Revit_PlagIn_Practicum_Lesson7
{
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            foreach (Duct d in ducts)
            {
                ...
                foreach(ReferenceWithContext refer in intersections)
                {
                   ...
                   /* if (d.Diameter != null)
                    {
                        width.Set(d.Diameter * 1.1);
                        height.Set(d.Diameter * 1.1);
                    }
                    else if (d.Width != null && d.Height != null)*/
                    {
                        width.Set(d.Width * 1.1);
                        height.Set(d.Height * 1.1);
                    }
                }            
            }
            ...
            foreach (Pipe p in pipes)
            {
                ...
                foreach (ReferenceWithContext referP in intersectionsP)
                {
                    ...
                    /*if (p.Diameter != null) */
                     {
                         width.Set(p.Diameter * 1.1);
                         height.Set(p.Diameter * 1.1);
                     }
                     /* else if (d.Width != null && d.Height != null)
                    {
                        width.Set(d.Width * 1.1);
